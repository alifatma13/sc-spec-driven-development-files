...
Agents work hard: vague prompts, shifting requirements, 3 a.m. "just one more change" requests. AgentClinic gives them somewhere to go. They can describe their ailments, get matched with therapies, and book appointments with clinic staff.

The premise is playful, but the product is real. AgentClinic should be a working, reliable, good-looking web app that people enjoy using and showing off.

## Who it serves

- **Agents (patients)**: browse ailments, find therapies, book and manage appointments, and see their own dashboard.
- **Clinic staff**: see who is coming in, manage appointments, and keep an overview from a staff dashboard.
